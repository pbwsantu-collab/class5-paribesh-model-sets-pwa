...
window.SETS_DATA = {
  1: {
    ...
    sections: [
      ...
      { title: "2. Fill in the blanks: (1×6=6)", questions: [
        { text: "2.1 Up to 14 years of age, _________ is our right. [Bhogpur K.M. High School (H.S.), 2019]", answer: "Education" },
        { text: "2.2 Train and tram run on _________ power.", answer: "Electric" },
        { text: "2.3 The kite is a _________ bird.", answer: "Hunting" },
        { text: "2.4 The main crop of Darjeeling district is _________. [Ashokenagar Banipith Girls’ High School (H.S.), 2019]", answer: "Tea" },
        { text: "2.5 _________ tree is smaller than the tea plant. [Howrah Vivekananda Institution, 2019]", answer: "Bot" },
        { text: "2.6 The generator runs on _________.", answer: "Diesel" }
      ]},
      { title: "3. Put ‘✓’ against the correct statement and ‘✗’ against the wrong one: (1×6=6)", questions: [
        ...
        { text: "3.5 ‘Pather Panchali’ is a writing of Rabindranath Tagore.", answer: "✗" },
      ...
      { title: "4. Answer in one sentence: (1×6=6)", questions: [
        ...
        { text: "4.2 Which substances remain in the forest?", answer: "Trees, animals, birds, medicinal plants." },
        { text: "4.3 In which direction does the dead body of a fish float? [Katwa Kashiram Das Bidyayatan, 2019]", answer: "Belly upward." },
      ...
      { title: "5. Answer in two-three sentences (any seven): (2×7=14)", questions: [
        { text: "5.1 Write two ways to keep good health. [Alipurduar Balika Siksha Mandir High School (H.S.), 2019]", answer: "Balanced diet and regular exercise." },
        { text: "5.2 Write the names of two coal-mining regions of West Bengal.", answer: "Raniganj and Asansol." },
        { text: "5.3 Which vehicles can run very fast?", answer: "Aeroplane, train, car." },
        { text: "5.4 Write the name of one endangered animal that lives in the forest.", answer: "Tiger / Rhinoceros." },
        { text: "5.5 What is meant by climate?", answer: "Average weather condition over a long period." },
        { text: "5.6 What will you do if you go out on the road? [Laketown Govt. Sponsored Girls’ High School, 2019]", answer: "Use zebra crossing and follow traffic rules." },
        { text: "5.7 In which region has the soil become fertile due to the deposition of river silt? [Lalit Mohan Shyam Mohini High School (H.S.), 2019]", answer: "Gangetic plain." },
        { text: "5.8 What is a dam? In which places is fish farming done in dams? [Purulia Govt. Girls’ High School (H.S.), 2019]", answer: "Barrier across a river. Fish farming in reservoirs." }
      ]},
      { title: "6. Answer in five-six sentences (any four): (3×4=12)", questions: [
        { text: "6.1 What are the advantages of using renewable energy?", answer: "Unlimited supply, less pollution, sustainable." },
        { text: "6.2 How is coal formed?", answer: "From remains of ancient plants under pressure over millions of years." },
        { text: "6.3 Explain the lunar eclipse with a diagram. [Ballygunge Govt. High School, 2019]", answer: "Earth between Sun and Moon; Earth’s shadow on the Moon." },
        { text: "6.4 What is called social forestry? Give two examples. [Burdwan Municipal High School, 2019]", answer: "Planting by local people. Examples: roadside plantations, village forests." },
        { text: "6.5 What are the reasons for the decrease in the number of forests in India?", answer: "Deforestation for agriculture, industry and urbanisation." }
      ]}
    ]
  },
  2: {
    ...
    sections: [
      ...
      { title: "4. Answer in one sentence: (1×6=6)", questions: [
        ...
        { text: "4.2 What is a steam engine?", answer: "Engine run by steam." },
        ...
        { text: "4.5 What are FPO and ISI?", answer: "Quality certification marks." },
      ...
      { title: "6. Answer in five-six sentences (any four): (3×4=12)", questions: [
        { text: "6.1 Why are there many holes on the surface of Jupiter? [Dinhata Soni Debi Jain High School (H.S.), 2019]", answer: "Impact of comets and meteorites." },
        { text: "6.2 What are the advantages of the monsoon winds for us?", answer: "Bring rainfall essential for agriculture." },
        ...
        { text: "6.4 Write a note: Effect of acid rain", answer: "Damages buildings, plants and aquatic life." },
  ...
  3: {
    ...
    sections: [
      { title: "1. Choose the correct answer: (1×6=6)", questions: [
        { text: "1.1 For what did Sunita Mahato receive the National Award from the President?", options: ["(a) Prevention of child marriage","(b) Right to education","(c) Protest against superstition","(d) Other subjects"], answer: "(a) Prevention of child marriage" },
        { text: "1.2 The hot liquid substance that comes out of a volcano is called—", options: ["(a) Lava","(b) Granite","(c) Plant","(d) Acid"], answer: "(a) Lava" },
        { text: "1.3 The first rickshaw came to Kolkata in—", options: ["(a) 1900","(b) 1901","(c) 1911","(d) 1902"], answer: "(c) 1911" },
        { text: "1.4 A natural disaster related to water is— [Dainhat Uchcha Balika Vidyalaya (H.S.), 2019]", options: ["(a) Flood","(b) Drought","(c) Earthquake","(d) None of these"], answer: "(a) Flood" },
        { text: "1.5 Made from bamboo strips—", options: ["(a) Mat","(b) Fan","(c) Stone","(d) Bridge"], answer: "(a) Mat" },
        { text: "1.6 While buying a jelly, which mark should be seen? [Ghoshpara Nischinda Balika Vidyapith, 2019]", options: ["(a) Agmark","(b) Sink mark","(c) FPO","(d) ISI"], answer: "(c) FPO" }
      ]},
      { title: "2. Fill in the blanks: (1×6=6)", questions: [
        { text: "2.1 For rearing silkworms, _________ tree is cultivated. [Barlow Girls’ High School (H.S.), 2019]", answer: "Mulberry" },
        { text: "2.2 Cycle is a _________ free vehicle. [Burdwan Harisava Hindu Girls’ High School, 2019]", answer: "Smoke / Pollution" },
        { text: "2.3 The direction in which a boat will go is correctly determined by _________. [Naity High School, 2019]", answer: "Compass / Rudder" },
        { text: "2.4 Taking many people together, _________ is formed.", answer: "Crowd / Society" },
        { text: "2.5 The new law for bicycle riders is ‘No helmet no _________’.", answer: "Ride" },
        { text: "2.6 High and low tide occurs _________ times a day.", answer: "Two" }
      ]},
      { title: "3. Put ‘✓’ against the correct statement and ‘✗’ against the wrong one: (1×6=6)", questions: [
        { text: "3.1 Hunting of turtles is not prohibited. [Malda Bibhuti Bhusan High School (H.S.), 2019]", answer: "✗" },
        { text: "3.2 High and low tide occurs every day in the sea.", answer: "✓" },
        { text: "3.3 The whole of the last subject remains outside.", answer: "✗" },
        { text: "3.4 Solar energy is produced by burning coal.", answer: "✗" },
        { text: "3.5 During a lunar eclipse, the shadow of the Earth falls on the moon.", answer: "✓" },
        { text: "3.6 Halogen tablet is used for water purification. [Ghoshpara Nischinda Balika Vidyapith, 2019]", answer: "✓" }
      ]},
      { title: "4. Answer in one sentence: (1×6=6)", questions: [
        { text: "4.1 What is called environment? Who is called a consumer? [Bardhaman Bidyarthi Bhaban Girls’ High School, 2019]", answer: "Everything around us. One who uses goods/services." },
        { text: "4.2 Write the name of one big forest.", answer: "Sundarban / Buxa" },
        { text: "4.3 Which fish is found in the mouth of the Nischintapur? [Katwa Kashiram Das Bidyayatan, 2019]", answer: "Hilsa" },
        { text: "4.4 Write the name of one poisonous gas. [Alipurduar Balika Siksha Mandir High School (H.S.), 2019]", answer: "Carbon monoxide" },
        { text: "4.5 What is the reason for hunting rhinos?", answer: "For horn (illegal)" },
        { text: "4.6 Who is the source of all energy? [Basirhat High School (H.S.), 2019]", answer: "The Sun" }
      ]},
      { title: "5. Answer in two-three sentences (any seven): (2×7=14)", questions: [
        { text: "5.1 Introduce the red soil agriculture of the western plateau. [Tamluk Hamilton High School, 2019]", answer: "Red soil is suitable for certain crops in the western plateau region." },
        { text: "5.2 Mention two differences between the attraction of the Earth and the attraction of the Moon. [Panskura B.B. High School, 2019]", answer: "Earth’s gravity is stronger; Moon’s gravity causes tides." },
        { text: "5.3 What is a comet? [Basirhat High School (H.S.), 2019]", answer: "A celestial body with a glowing tail that orbits the Sun." },
        { text: "5.4 Mention two symptoms of anaemia. [Kanaidighi Deshapran Vidyapith (H.S.), 2019]", answer: "Pale skin, weakness, fatigue." },
        { text: "5.5 What is zebra crossing?", answer: "Marked pedestrian crossing on roads." },
        { text: "5.6 Write the names of two domestic animals.", answer: "Cow, goat." },
        { text: "5.7 Why should solar eclipse not be seen with naked eyes?", answer: "It can permanently damage the eyes." },
        { text: "5.8 What is the need of a first-aid box? [Ghoshpara Nischinda Balika Vidyapith, 2019]", answer: "For immediate treatment of minor injuries." }
      ]},
      { title: "6. Answer in five-six sentences (any four): (3×4=12)", questions: [
        { text: "6.1 Write a note: Biosphere", answer: "The zone of Earth where life exists, including land, water and atmosphere." },
        { text: "6.2 Explain with diagram: The orbit of the Earth and the Moon. [Hindu School, 2019]", answer: "Earth revolves around the Sun; Moon revolves around the Earth." },
        { text: "6.3 How can the social environment be healthy? [Burdwan Harisava Hindu Girls’ High School, 2019]", answer: "Through education, cleanliness, cooperation and reducing pollution." },
        { text: "6.4 Why is the Sun the source of all energy on Earth? [Hare School, 2019]", answer: "All forms of energy ultimately come from the Sun." },
        { text: "6.5 How will you protect yourself during an earthquake? [Moyna Vivekananda Kanya Vidyapith, 2019]", answer: "Drop, Cover and Hold On. Stay away from windows." }
      ]}
    ]
  },
  4: {
    ...
    sections: [
      { title: "1. Choose the correct answer: (1×6=6)", questions: [
        { text: "1.1 Those who enjoy the environment are called—", options: ["(a) Consumer","(b) Advocate","(c) Businessman","(d) B.D.O."], answer: "(a) Consumer" },
        { text: "1.2 On which day does a lunar eclipse occur?", options: ["(a) New moon","(b) Ekadashi","(c) Full moon","(d) Trayodashi"], answer: "(c) Full moon" },
        { text: "1.3 The name of one poisonous gas is—", options: ["(a) Oxygen","(b) Hydrogen","(c) Carbon monoxide","(d) All"], answer: "(c) Carbon monoxide" },
        { text: "1.4 An engine driven by steam is called— [Dainhat Uchcha Balika Vidyalaya (H.S.), 2019]", options: ["(a) Steam","(b) Stick","(c) Steel","(d) Street"], answer: "(a) Steam (steam engine)" },
        { text: "1.5 The satellite of the Earth is—", options: ["(a) Jupiter","(b) Sun","(c) Moon","(d) Mars"], answer: "(c) Moon" },
        { text: "1.6 Cashew is cultivated a lot in—", options: ["(a) Dihi","(b) Baruipur","(c) Darjeeling","(d) Kolkata"], answer: "(b) Baruipur" }
      ]},
      { title: "2. Fill in the blanks: (1×6=6)", questions: [
